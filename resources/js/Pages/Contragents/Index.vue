        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
            <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
                            ...
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search"
                                           ...
                                           placeholder="Пошук за назвою, ЄДРПОУ" required="">
                                </div>
                            </form>
                        </div>
                        <div
                            ...
                            <button type="button" id="createProductModalButton" data-modal-target="createProductModal"
                                    ...
                                    v-on:click="this.$inertia.visit(route('contragents.create'))"
                            >
                            ...
                            <div class="flex items-center space-x-3 w-full md:w-auto">
                                <Select :data="[{id: '', name: '--Вид діяльності--'}, ...contragent_types]" style="color: black !important;" v-model="form.type_id"></Select>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr v-for="contragent in contragents.data" :key="contragents.id"
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button :id="'contragent-' + contragent.id + '-dropdown-button'" :data-dropdown-toggle="'contragent-' + contragent.id + '-dropdown'"
                                ...
                                <div :id="'contragent-' + contragent.id + '-dropdown'" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" :aria-labelledby="'contragent-' + contragent.id + '-dropdown-button'">
                                        <li>
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Відображається
                    <span class="font-semibold text-gray-900 dark:text-white">{{contragents.from}} - {{contragents.to}}</span>
                    з
